...
import static com.epam.ta.reportportal.ws.reporting.ValidationConstraints.MAX_TEST_ITEM_UNIQUE_ID_LENGTH;
...
public class StartTestItemRQ extends StartRQ {
	...
	@Schema(requiredMode = RequiredMode.REQUIRED, allowableValues = "SUITE, STORY, TEST, SCENARIO, STEP, BEFORE_CLASS, BEFORE_GROUPS,"
